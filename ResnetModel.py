...
class DecoderLSTM(nn.Module):
    def __init__(self, emb_dim , decoder_dim, vocab_size, num_layers=1):
        ...
        self.lstm = nn.LSTM(input_size = emb_dim ,hidden_size = decoder_dim,
    ...
    def forward(self, image_features, encoded_captions, caption_lengths):
        ...
        for t in range(max(decode_lengths)):
            ...
            h1, c1 = self.lstm(torch.cat(image_features_mean [:batch_size_t, t, :],embeddings[:batch_size_t, t, :], dim=1), (h1[:batch_size_t], c1[:batch_size_t]))
